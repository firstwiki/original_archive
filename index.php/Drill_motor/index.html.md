...
Horsedrawncarriage.gif)](Image:Horsedrawncarriage.gif "" ) |
**Obsolete**  
...
parts](Kit_of_parts "Kit of parts" ). The drill motor, along with
the [CIM motor](CIM_motor "CIM motor" ), are the two most powerful
motors included by a significant margin. One of the two basic [skid
steer](Skid_steer "Skid steer" ) [drive
trains](Drive_train "Drive train" ) included in the [kit of
parts](Kit_of_parts "Kit of parts" ) utilizes one drill motor on
each side of the [robot](Robot "Robot" ).
...
g)](Image:Drill_motor_graphs_no_GB.png
...
(Image:Drillmotorgraphs.JPG "Drill Motor Torque and Efficieny
Graphs" )
...
door](Van_door_motor "Van door motor" ) | **Drill** | [Fisher
