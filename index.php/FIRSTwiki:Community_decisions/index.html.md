...
[Boydean](User:Boydean "User:Boydean" ) 00:09, 27 May 2011 (EDT)
...
list](Template:Incomplete-list "Template:Incomplete-list" ) and
[Template:Incomplete-lists](Template:Incomplete-lists "Template
...
:Incomplete-list-suttle? Thoughts? [Tanner](User:TannerLD
...
especially with red links. Thoughts [Tanner](User:TannerLD
...
[547](547 "547" ) has about 3-5 of these, in various states of
...
Compromise? [Tanner](User:TannerLD "User:TannerLD" ) 08:16, 18
March 2010 (EDT)

[[edit](/index.php?title=FIRSTwiki:Community_decisions&action=edit&section=6
"Edit section: Poorly Named Files" )]

## Poorly Named Files

I know its not something we all want to face, but it needs to be dealt with,
[Category:Poorly_named](Category:Poorly_named "Category:Poorly
...
names to link to. [Boydean](User:Boydean "User:Boydean" ) 21:32, 15
March 2010 (EDT)
...
[Template:stub](Template:Stub "Template:Stub" ), with the same
background, size, content and what nots? This will help with constancy when
jumping around articles in the wiki. [Boydean](User:Boydean
...
events page](Category:FLL_Events "Category:FLL Events" ) as a
example, but it is not very developed. Thoughts?
[Tanner](User:TannerLD "User:TannerLD" ) 20:45, 13 March 2010 (EST)
...
On [Competitions](Competitions "Competitions" ), don't FLL and FTC
have championships as well? Then shouldn't they have said pages for that?
[Tanner](User:TannerLD "User:TannerLD" ) 20:50, 13 March 2010 (EST)
...
[Kamocat](User:Kamocat "User:Kamocat" ) 02:13, 23 July 2010 (EDT)

This does not appear to be a current issue: several people have managed to
upload without problem. [Nathan Hui](User:Nathan_Hui "User:Nathan
...
Noticed how the [Game](Game "Game" ) page is kinda solely focused
...
[Tanner](User:TannerLD "User:TannerLD" ) 20:30, 15 March 2010 (EDT)
...
Should fix so pages like [drive train](Drive_train "Drive train" )
follow.[Tanner](User:TannerLD "User:TannerLD" ) 21:52, 13 March
2010 (EST)
...
)[Denman](User:Denman "User:Denman" ) 11:26, 11 Oct 2005 (EDT) I
...
It's been over a month....I move for a vote, and I also move that until such
time as a vote shall be held, the Temp logo (2.1) be replaced with the puzzle
ball logo, revision 3 (2.4.3). --[Goobergunch](User:Goobergunch
...
only have to think it is really good.) --[Mrawls](User:Mrawls
...
([PBASIC](PBASIC "PBASIC" ) currently is not, but I wanted to see
...
change in the future, it probably should. --[Mrawls](User:Mrawls
...
It's been more then 4 days since the FF page has been the Feature article ;).
I think it's time for a change. --[Sciencewhiz](User:Sciencewhiz
...
--[Mrawls](User:Mrawls "User:Mrawls" ) 09:38, 17 Jun 2004 (EDT)
...
I created the templates so that Wikipedia links would look different than
...
--[SilverStar](User:SilverStar "User:SilverStar" )
...
out where) --[Astronouth7303](User:Astronouth7303
...
(Advay)](User:SilverStar "User:SilverStar" ) 23:06, 16 Jun 2004
(EDT)
...
Retrieved from
"<http://www.firstwiki.netFIRSTwiki:Community_decisions>"
