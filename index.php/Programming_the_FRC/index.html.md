...
The [PICmicro](PICmicro "PICmicro" ) can be programmed in C or
assembly. [MPLAB](MPLAB "MPLAB" ) IDE is the name of the free
Windows program used to edit, compile, and debug programs. To
[download](Downloading_a_program "Downloading a program" ) a
program, [IFI loader](IFI_loader "IFI loader" ) must be used. This
software is included in the [kit of parts](Kit_of_parts "Kit of
parts" ), and is availalbe on the [InnovationFIRST](InnovationFIRST
...
Also allowed by the [compiler](MCC18 "MCC18" ), but not documented,
...
types](List_of_data_types "List of data types" ) for more
...
extensively in the [default code](Default_code "Default code" ) to
...
instance, if a [potentiometer](Potentiometer "Potentiometer" ) in
...
Retrieved from
"<http://www.firstwiki.netProgramming_the_Robot_Controller>"

[Categories](/index.php?title=Special:Categories&article=Programming_the_Robot
_Controller "Special:Categories" ):
[Programming](Category:Programming "Category:Programming" ) | [How-
to](Category:How-to "Category:How-to" )
