...
[motors](Motors "Motors" ), for example) relying soley on user
input (from the [Operator Interface's](Operator_Interface "Operator
Interface" ) [joysticks](joystick), for example).

  
[![Schematic for an open loop
system](/media/b/b8/Openloopsystem.JPG)](Image:Openloopsystem.JPG
